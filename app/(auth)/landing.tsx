    ...
    return (
        <View style={{width: w, height: h, backgroundColor: BG}}>
            ...
            >
                ...
                <View style={{alignItems: 'center', justifyContent: 'center', marginBottom: 28}}>
                    ...
                    >
                        ...
                        <Image
                            ...
                            style={{height: 100 ,width:100, marginBottom:13}}
                        /></View>
                </View>
                ...
                >
                    AI + NLP transforms your profile into a perfectly tailored, ATS-optimised resume — in under 60
                    seconds.
                </Text>
    ...
    return (
        <View style={{width: w, height: h, backgroundColor: BG}}>
            ...
            >
                ...
                <Text style={{color: TEXT_DIM, fontSize: 13, lineHeight: 20, marginBottom: 20}}>
                    Drag-and-drop builder with professionally designed templates. Every layout is ATS-safe and
                    industry-tested.
                </Text>
    ...
    const cards = [
        {
            ...
            color: '#3b82f620',
            tColor: '#60a5fa',
            q: 'Walk me through your experience with React and state management patterns.'
        },
        {
            type: 'Behavioral',
            color: '#8b5cf620',
            tColor: '#a78bfa',
            q: 'Describe a time you handled a high-pressure deadline under resource constraints.'
        },
        {
            type: 'Scenario',
            color: `${GOLD}18`,
            tColor: GOLD,
            q: 'How would you approach diagnosing a sudden 40% drop in application performance?'
        },
    ];
        ...
        <View style={{width: w, height: h, backgroundColor: BG}}>
            ...
            >
                ...
                >
                    ...
                    >
                        I applied to 20 jobs and got 14 callbacks. ResuCraft's ATS optimization is genuinely different —
                        it completely changed my job search.
                    </Text>
        ...
        ({item}: ListRenderItemInfo<SlideId>) => {
            ...
            switch (item) {
                ...
                case 'ai':
                    return <AISlide        {...p} />;
                case 'design':
                    return <DesignSlide    {...p} />;
                case 'interview':
                    return <InterviewSlide {...p} />;
                case 'cta':
                    return <CTASlide       {...p} router={router}/>;
            }
        },
